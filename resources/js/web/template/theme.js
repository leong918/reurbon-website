...
export default function initTemplate() {
        ...
        if ($("body").hasClass("tt-m-menu-open")) {
                ...
                .on("click", function () {
                    ...
                    var tl_MenuClick = gsap.timeline({
                        onComplete: function () {
                            ...
                            $(".tt-submenu-trigger").removeClass(
                                "tt-m-submenu-open"
                            );
                    ...
                    tl_MenuClick.to(".tt-main-menu", {
                        duration: 0.4,
                        autoAlpha: 0,
                    });
                    tl_MenuClick.set(".tt-main-menu-list > li", {
                        clearProps: "all",
                    }); // clearProps only
            ...
            var tl_MenuOut = gsap.timeline({
                onComplete: function () {
                    ...
                    $("body").removeClass(
                        "tt-m-menu-active tt-m-menu-toggle-no-click"
                    );
                },
            });
            ...
            tl_MenuOut.set(".tt-main-menu-content > ul > li", {
                clearProps: "all",
            }); // clearProps only
        }
    ...
    // ============================
    var $olMenuToggleBtn = $(
        ".tt-ol-menu-toggle-btn-text, .tt-ol-menu-toggle-btn,.tt-ol-menu-toggle-btn-custom"
    );
                ...
                .on("click", function () {
                    ...
                    var tl_olMenuClick = gsap.timeline({
                        onComplete: function () {
                            ...
                            $(".tt-ol-submenu-trigger").removeClass(
                                "tt-ol-submenu-open"
                            );
                            $("html").removeClass("tt-no-scroll");
                            $("body").removeClass(
                                "tt-ol-menu-active olm-toggle-no-click"
                            );
                        },
                    });
        ...
        $(".tt-portfolio-slider").each(function () {
            ...
            if ($ttPortfolioSlider.is("[data-pagination-type]")) {
                var $dataPaginationType =
                    $ttPortfolioSlider.data("pagination-type");
            } else {
            ...
            var $ttPortfolioSliderSwiper = new Swiper(
                $ttPortfolioSlider.find(".swiper")[0],
                {
                    ...
                    // Navigation arrows
                    navigation: {
                        nextEl: $ttPortfolioSlider.find(
                            ".tt-ps-nav-arrow-next"
                        )[0],
                        prevEl: $ttPortfolioSlider.find(
                            ".tt-ps-nav-arrow-prev"
                        )[0],
                    ...
                    on: {
                        init: function () {
                            ...
                            setTimeout(function () {
                                if (
                                    $slideActive.hasClass("psi-image-is-light")
                                ) {
                                    $("body").addClass(
                                        "tt-light-bg-on psi-light-bg-on"
                                    );
                                } else {
                                    $("body").removeClass(
                                        "tt-light-bg-on psi-light-bg-on"
            ...
            if (!isMobile) {
                if ($ttPortfolioSlider.data("parallax-mouse-move")) {
                    ...
                    $ttPortfolioSlider.mousemove(function (e) {
                        parallaxIt(
                            e,
                            $ttPortfolioSlider.find(".tt-psi-image"),
                            -25
                        ); // Parallax element
                        parallaxIt(
                            e,
                            $ttPortfolioSlider.find(".tt-ps-caption-inner"),
                            -35
                        ); // Parallax element
                    });
    ...
    if ($(".tt-portfolio-carousel").length) {
        $(".tt-portfolio-carousel").each(function () {
            ...
            var $dataSimulateTouch =
                $ttPortfolioCarousel.data("simulate-touch");
            ...
            var $ttPortfolioCarouselSwiper = new Swiper(
                $ttPortfolioCarousel.find(".swiper")[0],
                {
                    ...
                    // Navigation arrows
                    navigation: {
                        nextEl: $ttPortfolioCarousel.find(
                            ".tt-pc-arrow-next"
                        )[0],
                        prevEl: $ttPortfolioCarousel.find(
                            ".tt-pc-arrow-prev"
                        )[0],
                    ...
                    on: {
                        ...
                        transitionStart: function () {
                            ...
                            $slideActive
                                .prev()
                                .addClass("tt-slide-active-start"); // Add class if active slide transition starts.
                            $slideActive
                                .next()
                                .addClass("tt-slide-active-start"); // Add class if active slide transition starts.
                        ...
                        transitionEnd: function () {
                            ...
                            $slideActive
                                .prevAll()
                                .removeClass("tt-slide-active"); // Remove class if active slide transition ends.
                            $slideActive
                                .nextAll()
                                .removeClass("tt-slide-active"); // Remove class if active slide transition ends.
                            $slideActive
                                .prev()
                                .removeClass("tt-slide-active-start"); // Remove class if active slide transition ends.
                            $slideActive
                                .next()
                                .removeClass("tt-slide-active-start"); // Remove class if active slide transition ends.
                            ...
                            // Disable nav arrow action.
                            $(".tt-pc-arrow").removeClass(
                                "tt-pc-arrow-disabled"
                            );
                        },
                    },
                }
                    ...
                    $ttPortfolioCarousel
                        ...
                        .on("mousedown touchstart pointerdown", function (e) {
                            if (e.which === 1) {
                                ...
                                gsap.to(
                                    $ttPortfolioCarousel.find(".tt-pci-inner"),
                                    { duration: 0.7, scale: 0.9 }
                                );
                            }
                        });
                    $("body").on(
                        "mouseup touchend pointerup mouseleave",
                        function () {
                            gsap.to(
                                $ttPortfolioCarousel.find(".tt-pci-inner"),
                                { duration: 0.7, scale: 1, clearProps: "scale" }
                            );
                        }
                    );
                }
    ...
    if ($(".tt-portfolio-hover-carousel").length) {
        ...
        $(".tt-portfolio-hover-carousel").each(function () {
            ...
            // ================
            var $dataSimulateTouch =
                $ttPortfolioHoverCarousel.data("simulate-touch");
    ...
    if ($(".tt-blog-carousel").length) {
        $(".tt-blog-carousel").each(function () {
            ...
            if ($ttBlogCarousel.is("[data-pagination-type]")) {
                var $dataPaginationType =
                    $ttBlogCarousel.data("pagination-type");
            } else {
    ...
    if ($(".tt-testimonials-slider").length) {
        $(".tt-testimonials-slider").each(function () {
            ...
            // ================
            var $dataSimulateTouch =
                $ttTestimonialsSlider.data("simulate-touch");
            ...
            var $ttTestimonialsSliderSwiper = new Swiper(
                $ttTestimonialsSlider.find(".swiper")[0],
                {
                    ...
                    // Navigation (arrows)
                    navigation: {
                        nextEl: $ttTestimonialsSlider.find(
                            ".tt-ts-nav-next"
                        )[0],
                        prevEl: $ttTestimonialsSlider.find(
                            ".tt-ts-nav-prev"
                        )[0],
                ...
                $ttTestimonialsSlider
                    ...
                    .on("mousedown touchstart pointerdown", function (e) {
                        if (e.which === 1) {
                            // Affects the left mouse button only!
                            gsap.to(
                                $ttTestimonialsSlider.find(".tt-ts-item-inner"),
                                { duration: 0.7, scale: 0.9 }
                            );
                        }
                    });
    ...
    // 	// Register packery mode for Isotope
    // 	Isotope.modeDefinitions = Isotope.modeDefinitions || {};
    // 	Isotope.modeDefinitions.packery = packeryMode;

    // 	const iso = new Isotope($container.get(0), {
    ...
    // Initialize lightGallery using Vite-compatible import

    // Initialize lightGallery for each .lightgallery element
    $(".lightgallery").each(function () {
        lightGallery(this, {
            ...
            rotate: false,
            share: false,
            plugins: [lgVideo, lgFullscreen, lgAutoplay, lgZoom, lgThumbnail],
        });
    });
    ...
    if ($("#portfolio-grid").hasClass("pgi-cap-inside")) {
        ...
        $(".portfolio-grid-item").each(function () {
            $(this)
                .find(".pgi-caption")
                .appendTo($(this).find(".pgi-image-wrap"));
        });
